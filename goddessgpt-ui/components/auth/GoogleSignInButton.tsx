...
export function GoogleSignInButton() {
  ...
  return (
    <Button 
      size="lg"
      className="bg-white hover:bg-gray-50 text-gray-800 px-6 py-6 h-auto font-medium text-base sm:text-lg rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-3 border border-gray-200 w-full max-w-sm"
